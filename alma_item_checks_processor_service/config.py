...
REPORTS_CONTAINER = os.getenv(
    "REPORTS_CONTAINER", "reports-container"
)  # Generated reports

SCF_NO_ROW_TRAY_STAGE_TABLE = os.getenv(
    "SCF_NO_ROW_TRAY_STAGE_TABLE", "scfnorowtraystagetable"
)
SCF_NO_ROW_TRAY_REPORT_TABLE = os.getenv(
    "SCF_NO_ROW_TRAY_REPORT_TABLE", "scfnorowtrayreporttable"
)
IZ_NO_ROW_TRAY_STAGE_TABLE = os.getenv(
    "IZ_NO_ROW_TRAY_STAGE_TABLE", "iznorowtraystagetable"
)

IZ_NO_ROW_TRAY_NCRON = os.getenv("IZ_NO_ROW_TRAY_NCRON", "0 45 23 * * 0-4")
SCF_NO_ROW_TRAY_REPORT_NCRON = os.getenv(
...
EXCLUDED_NOTES = ["At WRLC waiting to be processed", "DO NOT DELETE", "WD"]
